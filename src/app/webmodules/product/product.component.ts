...
data = [
  {
    ...
    description: 'An intelligent collaboration platform that connects customers with professional interior designers for residential, commercial, and layout-based projects. Customers can submit project requests online, while design teams, admins, supervisors, and vendors work together seamlessly through a unified system—ensuring smooth communication, faster approvals, and efficient project execution.',
    images: [
  ...
  },
  {
    ...
    description: ' The SLMS app simplifies education management with an easy dashboard, course sign-ups, progress tracking, and secure storage. It also uses AI for personalized course suggestions, offers a chatbot for quick help, and has discussion rooms for student interaction, enhancing the learning experience.',
    images: [
  ...
  },
  {
    ...
    description: 'A next-generation AI-enabled code security platform that integrates Salesforce, GitHub, and OpenAI to scan repositories, detect vulnerabilities, and deliver instant, intelligent fix suggestions. Developers can apply solutions directly through the UI, ensuring fast and seamless remediation.',
    image: 'https://conformance1.com/wp-content/uploads/2024/05/AI-in-cybersecurity-1024x528.jpg',
    features: [
...
formatText(text: string, features?: string[]): string {
