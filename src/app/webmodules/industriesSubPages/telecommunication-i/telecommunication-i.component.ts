...
export class TelecommunicationIComponent {
  ...
  // Common steps array for all sections
  commonSteps = [
    {
      title: 'Understand',
      icon: '',
  ...
  sections: Record<string, Section> = {
    dataPrivacy: {
      ...
      smallHeading:
        'Customer trust begins with secure communication.',
    ...
    automation: {
      ...
      heroHeading: 'How Is Automation Changing the Future of Telecom?',
      smallHeading:
        'Exploring smarter networks and faster communication',
      text: 'Our Working Strategy',
      whyList: [
        {
    ...
    managedSolutions: {
      ...
      smallHeading:
        'Unlock productivity with dependable IT services.',
      text: 'Our Working Strategy',
      whyList: [
        {
