 ...
 public currentSection = 'StrategicRiskAndResilence';
  ...
  public sections = {
    ...
    StrategicRiskAndResilence: {
      ...
      points: [
        {
          title: 'Risk Management Protecting Resources and Building Trust',
          description:
      ...
      points: [
        {
          ...
          description:
            'Government agencies often work in silos, which limits efficiency. IT consulting introduces integrated communication platforms that allow departments to share updates instantly, ensuring better decision-making and faster response to citizen needs.',
        },
        {
        ...
        },
        {
          ...
          description:
            'Agencies can collaborate on policy development through shared applications and digital platforms. IT consultants design systems where multiple departments contribute insights, track progress, and align their work with national objectives.',
        },
        {
        ...
        },
        {
          ...
          description:
            'Through IT consulting, governments can adopt e-governance platforms that provide online services such as bill payments, licenses, and grievance redressal. This improves accessibility and reduces the need for in-person visits, saving time for both citizens and officials.',
        },
        {
    ...
    ProjectManagementExcellence: {
      ...
      points: [
        {
          title: 'Project Management for Effective Public Programs',
          description:
        ...
        {
          title: 'Driving Public Value Through Project Management',
          description:
