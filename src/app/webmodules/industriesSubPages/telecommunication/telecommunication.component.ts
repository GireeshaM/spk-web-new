...
export class TelecommunicationComponent {
  ...
  automation : {
    ...
    points: [
      ...
      {
        title: 'The Balance Human Touch and Automation Together Automation in IT Services Beyond Saving Time of Telecom Powered by Automation',
        description:
  ...
  points: [
    {
      title: 'Networking and Communication Services The Core of Digital Growth',
      description:
