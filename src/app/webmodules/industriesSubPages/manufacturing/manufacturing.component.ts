   ...
   salesforceIntegration : {
    ...
    points: [
      { title: 'Unified Customer View',
        description: 'Integration combines data from multiple sources into Salesforce, giving manufacturers a single source of truth. This helps sales teams understand customer needs better and provide personalized solutions.' },
      { title: 'Improved Demand Forecasting',
        description: 'By connecting sales and production data, manufacturers can analyze customer trends more accurately. This leads to better demand planning, reduced stockouts, and optimized production schedules.' },
      { title: 'Streamlined Order Management',
        description: 'Salesforce integration simplifies the order-to-cash cycle by connecting CRM with ERP systems. This ensures real-time updates on order status, reducing delays and enhancing customer satisfaction.' },
      { title: 'Enhanced Field Service Efficiency',
         description: 'Manufacturers can use Salesforce to assign service tasks, track technician availability, and monitor maintenance schedules. Integration ensures quick resolution of issues and minimizes machine downtime.' },
      { title: 'Data-Driven Decision Making',
        description: 'With dashboards and analytics powered by Salesforce, managers can monitor KPIs across production, inventory, and sales. This enables faster and smarter business decisions.' },
      { title: 'Stronger Supplier Collaboration',
        description: 'Integrating supplier data into Salesforce improves communication and collaboration. Manufacturers gain visibility into supply chain performance, helping prevent disruptions.' },
    ...
    points: [
      { title: 'Predictive Maintenance',
        description: 'Analytics identifies early warning signs of equipment failures by analyzing sensor and machine data. This helps prevent costly downtime, extends machine lifespan, and lowers maintenance expenses.' },
      { title: 'Optimized Production Planning',
         description: 'Data-driven forecasting aligns production schedules with demand trends. This reduces overproduction, eliminates bottlenecks, and ensures timely product delivery.' },
      { title: 'Quality Control and Defect Reduction',
         description: 'Advanced analytics monitors production quality in real time, detecting anomalies quickly. This reduces defective outputs, improves product consistency, and builds customer trust.' },
      { title: 'Enhanced Supply Chain Visibility',
         description: 'By analyzing supplier, logistics, and inventory data, manufacturers gain end-to-end supply chain transparency. This improves collaboration, reduces delays, and enhances resilience against disruptions.' },
      { title: 'Energy and Resource Optimization',
         description: 'Analytics helps identify energy inefficiencies across factories. Manufacturers can reduce energy consumption, optimize raw material use, and cut costs while supporting sustainability goals.' },
      { title: 'Smarter Demand Forecasting',
        description: 'Combining historical sales with market trends, analytics improves demand predictions. This ensures the right products are produced at the right time, avoiding shortages or excess stock.' },
   ...
   projectManagement : {
    ...
    points: [
      { title: 'Streamlined Project Execution',
        description: 'Expert project management introduces structured frameworks that reduce inefficiencies, eliminate redundancies, and ensure smooth project delivery across the manufacturing lifecycle.' },
      { title: 'Effective Resource Allocation',
        description: 'By analyzing workforce, materials, and capital requirements, managers can allocate resources optimally. This reduces waste and ensures critical tasks are prioritized for maximum impact.' },
      { title: 'Risk Anticipation and Mitigation',
        description: 'Manufacturing projects face challenges like supply chain delays, equipment issues, and regulatory hurdles. Project managers identify risks early and implement safeguards to minimize disruptions.' },
      { title: 'Improved Time Management',
        description: 'Project management techniques such as Agile, Lean, and Six Sigma enable faster execution. This helps manufacturers meet deadlines without compromising quality.' },
      { title: 'Cost Control and Budget Optimization',
         description: 'Through real-time tracking and performance monitoring, expert project managers keep expenses within budget while maximizing returns on investment.' },
      { title: 'Enhanced Collaboration Across Teams',
        description: 'Cross-functional teams—from engineers to quality assurance—work cohesively under guided project frameworks. This reduces communication gaps and strengthens accountability.' },
      { title: 'Focus on Compliance and Quality',
        description: 'Expert project management integrates compliance requirements and quality standards into each stage of manufacturing projects, ensuring products meet regulatory and market expectations.' },
