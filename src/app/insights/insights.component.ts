...
export class InsightsComponent {
 insights = [
    ...
    },
    {
      ...
      title: 'Demo: How the Salesforce Health Cloud changing Healthcare Industry'
    },
    {
      image: '/assets/insights/4.jpg',
      title: 'Exploring the Potential of Salesforce Analytics Cloud & Compliance Use-cases in Business Intelligence'
    },
    {
      image: '/assets/insights/5.jpg',
      title: 'Empowering smart Business Reporting via potential of Salesforce CRM Analytics'
    },
    {
      image: '/assets/insights/6.jpg',
      title: 'Exploring the trending benefits of Choosing Salesforce Consultations'
    }
  ];
